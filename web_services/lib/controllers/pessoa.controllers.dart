import 'package:webservices/models/pessoa.model.dart';
import 'package:webservices/repositories/pessoa.repository.dart';
...
abstract class _PessoaController with Store{
  ...
  @observable
  AppStatus status = AppStatus.nome;
  ...
  Future<void> edit(Pessoa pessoa) async {
    ...
    try {
      ...
      if(isEdited){
        ...
        status = AppStatus.error..value = "Erro ao tentar alterar pessoas";
    }catch(e){
      status = AppStatus.error..value = e;
